...
def forward_to_chat(update, context):
    """{ 
        'message_id': 5, 
        'date': 1605106546, 
        'chat': {'id': 427003405, 'type': 'private', 'username': 'andrfrost', 'first_name': 'Alex', 'last_name': 'Bontillgut'}, 
        'text': 'TEST QOO', 'entities': [], 'caption_entities': [], 'photo': [], 'new_chat_members': [], 'new_chat_photo': [], 'delete_chat_photo': False, 'group_chat_created': False, 'supergroup_chat_created': False, 'channel_chat_created': False, 
        'from': {'id': 427003405, 'first_name': 'Alex', 'is_bot': False, 'last_name': 'Bontillgut', 'username': 'andrfrost', 'language_code': 'en'}
    }"""
...
def forward_to_user(update, context):
    """{
        ...
        'reply_to_message': {
            ...
            'chat': {'id': -484179205, 'type': 'group', 'title': '☎️ SUPPORT CHAT', 'all_members_are_administrators': True}, 
            'forward_from': {'id': 49820636, 'first_name': 'Alex', 'is_bot': False, 'last_name': 'Bontillgut', 'andrfrost': 'Bontillgut', 'language_code': 'en'}, 
            ...
            'from': {'id': 1309138849, 'first_name': 'SUPPORT', 'is_bot': True, 'username': 'lolkek'}
        }, 
